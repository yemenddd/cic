...
const EDITIONS: Edition[] = [
  {
    number: '01', year: '2023', labelAr: 'الانطلاقة الأولى', labelEn: 'The First Launch', labelTr: 'İlk Buluşma',
    videos: [
  ...
  {
    number: '02', year: '2024', labelAr: 'آفاق أوسع', labelEn: 'Expanding Horizons', labelTr: 'Ufukları Genişletmek',
    videos: [
  ...
  {
    number: '03', year: '2025', labelAr: 'أثر عالمي', labelEn: 'Global Impact', labelTr: 'Küresel Etki',
    videos: [
  ...
  {
    number: '04', year: '2026', labelAr: 'المستقبل الآن', labelEn: 'The Future Is Now', labelTr: 'Gelecek Şimdi',
    videos: [
      { id: 'REGcpGlNvC8', titleAr: 'التغطية المباشرة — اليوم الأول', titleEn: 'Live Coverage — Day 1', titleTr: 'Canlı Yayın — 1. Gün' },
      { id: 'XMZ4htBi20s', titleAr: 'التغطية المباشرة — اليوم الثاني', titleEn: 'Live Coverage — Day 2', titleTr: 'Canlı Yayın — 2. Gün' },
      { id: 'REGcpGlNvC8', titleAr: 'الكلمات الرئيسية 2026', titleEn: 'Keynotes 2026', titleTr: 'Keynote Konuşmalar 2026' },
      { id: 'XMZ4htBi20s', titleAr: 'الحفل الختامي', titleEn: 'Closing Ceremony', titleTr: 'Kapanış Töreni' },
    ],
  },
];
...
function editionToFrames(edition: Edition, lang: string) {
...
export default function VideosPage() {
  ...
  const frames = editionToFrames(edition, lang);
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 pt-20 md:pt-28 pb-10 w-full">
        ...
        >
          {EDITIONS.map((ed, i) => (
            ...
            >
              ...
              <span>{lang === 'ar' ? ed.labelAr : lang === 'tr' ? ed.labelTr : ed.labelEn}</span>
        ...
        >
          ...
          <span className="text-white font-semibold text-sm md:text-base">
            {lang === 'ar' ? edition.labelAr : lang === 'tr' ? edition.labelTr : edition.labelEn}
          </span>
          <span className="text-white/25 text-[12px]">
            · {edition.videos.length} {t('videos.count')}
          </span>
        </motion.div>

...
export default function AboutConference() {
  return (
    <FinancialHero
      ...
      description="The Creativity & Innovation Conference arrives at a turning point for Yemeni youth — where individual ambition meets the collective need to build a more stable, prosperous future."
